...
test('cheks if the hitpoints is greater than the strength', () => {
  const character = new Character('boy', 10,50);
...
test('checks if character is alive', () => {
  const character =new Character('boy', 10,50);
