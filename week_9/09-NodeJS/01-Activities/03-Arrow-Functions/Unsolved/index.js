...
//when it is a declaraction of a function, keep the return, more than one function keep {} and return
...
//one statement, can remove curly brackets and return statement
...
const netflixQueue = {
  ...
  //functional assignment, is scoped to the window in which it is declared. Currently globally declared. It needs explicit binding to netflix queue. Arrow functions are bound to object they are declared. 
  printQueue: function() {
    var list = '';
