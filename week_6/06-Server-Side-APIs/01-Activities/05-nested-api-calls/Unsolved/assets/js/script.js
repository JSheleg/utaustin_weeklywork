function myFunction() {
  fetch(
    ...
    .then(function(wikiResponse) {
      ...
      document.getElementById('title').appendChild(articleTitle);

      //need to clear title before adding next title and gif
      ...
      return fetch(
        'https://api.giphy.com/v1/gifs/search?q=' + title + '&rating=' + rating + '&api_key=HvaacROi9w5oQCDYHSIk42eiDSIXH3FN'
